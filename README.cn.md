...
![eksctl](https://repo.x-cmd.io/eksctl.svg?lang=zh)
...
合计: **449,202** 行代码（覆盖前 5 种语言、共 **2122** 个文件）。
...
- **上游仓库**: <https://github.com/eksctl-io/eksctl>
- **官网**: <https://eksctl.io>
- **许可证**: NOASSERTION
...
- **Star**: 5,211 · **Fork**: 1,501 · **开放 issue**: 2,950 · **贡献者**: 347

## 累计统计

- **发布数**: 555 · **已合并 PR**: 3800 · **开放 PR**: 11 · **已关闭 issue**: 2866 · **开放 issue**: 84 · **提交数**: 8534

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 2 | 16 | 7 | 0 | 1 | 17 |
| last60d | 2026-07-13 | 2 | 46 | 7 | 3 | 1 | 67 |
| 90d | 2026-06-13 | 6 | 56 | 9 | 5 | 1 | 75 |
| last180d | 2026-03-15 | 12 | 102 | 11 | 12 | 3 | 117 |
| 360d | 2025-09-16 | 32 | 204 | 11 | 44 | 4 | 212 |
| last720d | 2024-09-21 | 80 | 503 | 11 | 149 | 4 | 550 |
...
在 [repology.org](https://repology.org/project/eksctl) 上共有 **23** 个发行版报告此项目。**9** 个 ✅ 已是最新上游版本，**13** 个 ⚠️ 使用旧版本。
...
eksctl 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `eksctl` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/eksctl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T18:57:47Z._
